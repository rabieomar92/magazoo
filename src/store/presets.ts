...
const makeMagazine4 = (): Doc => {
  ...
  d.design = {
    ...
    sidebar: false,
    highlightsPlacement: 'page1',
    fontDisplay: 'Avenir Next LT Pro',
    fontBody: 'Avenir Next LT Pro',
    fontCategory: 'Avenir Next LT Pro',
    fontSubtitle: 'Avenir Next LT Pro',
    fontAuthor: 'Avenir Next LT Pro',
    fontAffiliation: 'Avenir Next LT Pro',
    frontCover: {
      alignment: 'left',
      storyTop: 15,
      storyWidth: 88,
