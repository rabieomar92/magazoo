...
import { newsPhotoPosition } from '../lib/newsLayout';

export const newNewsStory = (): NewsStory => ({
  id: uid(),
  title: 'New brief',
  text: '',
  caption: '',
...
export function makeNews(): Doc {
  ...
  const stories: NewsStory[] = [
    { ...newNewsStory(), layout: 'lead', widthCols: 3, textCols: 1, photoPosition: 'right', title: 'Opening the laboratory to new ideas',
    ...
    { ...newNewsStory(), layout: 'compact', widthCols: 2, textCols: 1, photoPosition: 'right', title: 'Small instruments, bigger questions',
    ...
    { ...newNewsStory(), layout: 'aside', widthCols: 1, textCols: 1, photoPosition: 'none', title: 'From the campus calendar',
    ...
    { ...newNewsStory(), layout: 'lead', widthCols: 3, textCols: 1, photoPosition: 'right', breakBefore: true, title: 'Science grows through collaboration',
  ...
  stories.forEach(story => {
    if (newsPhotoPosition(story) === 'none') return;
    const id = uid();
