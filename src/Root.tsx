...
export function Root(){
  ...
  return <ErrorBoundary><Suspense fallback={<div className="app-loading" role="status">Loading Magazoo editor…<div className="loading-track"><span /></div></div>}>{hash==='#admin'?<AdminPage/>:<App key={hash}/>}</Suspense></ErrorBoundary>;
}
